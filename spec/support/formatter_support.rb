  ...
  if RUBY_VERSION.to_f < 1.9
    def expected_summary_output_for_example_specs
      <<-EOS.gsub(/^\s+\|/, '').chomp
        ...
        |     # ./spec/support/sandboxing.rb:27:in `run'
        |     # ./spec/support/formatter_support.rb:13:in `run_example_specs_with_formatter'
        |     # ./spec/support/sandboxing.rb:32:in `instance_exec'
        |     # ./spec/support/sandboxing.rb:32:in `sandboxed'
        |     # ./spec/support/sandboxing.rb:31:in `sandboxed'
        |     # ./spec/support/sandboxing.rb:49
        |
    ...
    def expected_summary_output_for_example_specs
      <<-EOS.gsub(/^\s+\|/, '').chomp
        ...
        |     # ./spec/support/formatter_support.rb:13:in `run_example_specs_with_formatter'
        |     # ./spec/support/sandboxing.rb:32:in `instance_exec'
        |     # ./spec/support/sandboxing.rb:32:in `block in sandboxed'
        |     # ./spec/support/sandboxing.rb:31:in `sandboxed'
        |     # ./spec/support/sandboxing.rb:49:in `block (2 levels) in <top (required)>'
        |
        |  3) a failing spec with odd backtraces fails with a backtrace that has no file
